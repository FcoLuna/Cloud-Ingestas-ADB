...
val fieldLengths = List(18, 10, 18, 8, 6, 8, 8, 9, 1, 4, 3, 2, 4, 4, 3, 3, 2, 2, 1, 2, 1, 1, 4, 6, 7, 7, 10, 18, 1, 16)
val filename1 = dbutils.widgets.get("nombre_archivo")
val filePath = s"abfss://bigdataprd@stbigdataprd02.dfs.core.windows.net/data/trafico/trafico_mediacion/meco/larga_distancia_int_medido/stage_tmp/$filename1"
...
val destinationFilePath = "abfss://bigdataprd@stbigdataprd02.dfs.core.windows.net/data/trafico/trafico_mediacion/meco/larga_distancia_int_medido/stage"
...
val destinationPath = s"abfss://bigdataprd@stbigdataprd02.dfs.core.windows.net/data/trafico/trafico_mediacion/meco/larga_distancia_int_medido/stage"
