...
val filePath = s"abfss://bigdataprd@stbigdataprd02.dfs.core.windows.net/data/trafico/trafico_mediacion/meco/carrier_181_valorizado/stage_tmp/$filename1"
...
val destinationFilePath = "abfss://bigdataprd@stbigdataprd02.dfs.core.windows.net/data/trafico/trafico_mediacion/meco/carrier_181_valorizado/stage"
...
val destinationPath = s"abfss://bigdataprd@stbigdataprd02.dfs.core.windows.net/data/trafico/trafico_mediacion/meco/carrier_181_valorizado/stage"
