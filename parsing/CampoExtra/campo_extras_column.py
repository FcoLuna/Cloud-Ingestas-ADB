...
lista_columnas = [columna.replace("/","_").lower() for columna in lista_columnas]
lista_columnas = [columna.replace("enabled","fl_enabled").lower() for columna in lista_columnas]
lista_columnas = [columna.replace("tokenfl_enabled","tokenenabled").lower() for columna in lista_columnas]
...
ruta_stage      = ruta_stage.replace('temp_'+origen,origen)
(df
 .coalesce(1)
...
dbutils.fs.rm(f"{ruta_stage}/{nombre_archivo}")
