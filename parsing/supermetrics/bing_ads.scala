...
// MAGIC range_name = "BING!A1:G"  # Cambia el rango según sea necesario
// MAGIC
...
val filename = s"bing_ads_$dateStr.csv"
var output_rename = dbutils.widgets.get("output_rename")
//val output_rename = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/interacciones/canales/supermetrics/bing_ads/stage/"
