...
# MAGIC %md
# MAGIC ### Parsing para Ingesta PARQUE_DECO_IPTV_INSTALADO
# MAGIC El archivo que viene con esta ingesta tiene un retorno de carro en su contenido haciendo que se quiebre la lectura de los datos. Para esto se hace una nueva lectura, previa a validaciones prelanding. Este caso es el mismo de la ingesta DECO_ID_ACCESO
...
dbutils.fs.rm(f"{ruta_stage}/temp", True)
