...
val parsing_in = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/interacciones/canales/transacciones_app_mi_movistar/stage"
...
val txtPath = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/gestion_recursos/inventario_red/siiared/catalogo_celdas_movil/last_ingest_time.txt"
...
val hqlContent = spark.read.textFile(txtPath).collect().mkString("\n")
println(hqlContent)
...
val path1 = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/interacciones/canales/transacciones_app_mi_movistar/stage"
...
//df1.show(10, false)
//val distinctj = df1.select("FECTRAN").distinct().show(false)
val result_df = df1.groupBy("EVENT_DATE").count()
...
val filePath = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/interacciones/canales/logueos_app_mi_movistar/raw/year=2024/month=12"
...
//val df1 = df.select("fectran").distinct().show(false)
val result_df = df.groupBy("fectran").count()
...
val folderPath22 = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/gestion_recursos/inventario_red/siiared/catalogo_celdas_movil"
