...
// PARAMETROS
var dir_adls, dataType, plataforma, loadType, periodicity, partition_date_column, auxiliar_partition_value, formato_partition_column, formato_partition_column_out, starttime_nifi, endtime_nifi, original_file_size, original_file_date, data_source_name, timestampFormat, quote, nomb_proc, merge_string, schema, pipelineRunId, catalog_control = ""
...
auxiliar_partition_value =""
catalog_control ="bidesarrollo.control.control_ingestas"
dataType ="conformado"
data_source_name ="ODSCHILE.AGREEMENT"
dir_adls ="abfss://bigdatadev@stbigdatadev02.dfs.core.windows.net/modelos/ods/agreement"
endtime_nifi =" 20240704 191749"
formato_partition_column =""
formato_partition_column_out =""
loadType ="full"
merge_string =""
nomb_proc ="bidesarrollo.odschile.agreement"
original_file_date ="2024-07-04T23:14:53+00:00"
original_file_size ="632091607"
partition_date_column =""
periodicity ="d"
pipelineRunId ="c6656f6d-f173-44ee-8b04-cc61dd5b27cf"
plataforma ="ods"
quote =""
schema ="ODSCHILE"
starttime_nifi ="20240704 191230"
...
//       timestampFormat = Option(dbutils.widgets.get("timestampFormat")).filterNot(_.isEmpty).getOrElse("yyyy-MM-dd HH:mm:ss[.SSS][XXX]")
...
if(status_ejecucion == 0){
    try {
      ...
      df = defineSchemaJson(path_json, path_stage) 
    } catch {
        case e: Exception =>
          status_ejecucion = 1
          desc_status_ejecucion = "[ERROR] " + e
