...
try{
      ...
      */
      ...
      // df5.write.mode("overwrite").format("delta").save(path_tmp)
      println(path_tmp)
      ...
      print("Numero de particiones " + numPartitions)
      ...
      // df5.repartition(numPartitions).write.partitionBy(columns:_*).mode("append").format("delta").save(path_data)
