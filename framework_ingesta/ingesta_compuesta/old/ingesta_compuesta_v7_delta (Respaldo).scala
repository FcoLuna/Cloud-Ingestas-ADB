...
val dir_hdfs_2 = dbutils.widgets.get("dir_hdfs_2")
...
// val dir_hdfs_2 = "abfss://contenedor-test@stbigdatadev02.dfs.core.windows.net/data/gss_feedback_callout/landing/2023/12"
...
// val loadType = "i"
// val periodicity ="d" 
// val starttime_nifi = "20231231 123259"
// val endtime_nifi = "20231231 123508"
...
// val filename = "Feedback_GSS_20231229.csv"
// val partition_date_column = "Stats_Date"
// val quote = "\""
// val nomb_proc = "devtmp.raw_gss_feedback_callout.gss_feedback_callout"
// val nomb_schema = nomb_proc.split('.')(0)+"."+nomb_proc.split('.')(1)
// println(nomb_schema)
// val nomb_schema = "devtmp.raw_gestion_recursos"
...
try {
  ...
  spark.sql(s"""CREATE SCHEMA IF NOT EXISTS $nomb_schema MANAGED LOCATION '$dir_hdfs' COMMENT 'schema para datos de mov_sap_tienda'""")
} catch {
  case e: Exception =>
    {
      println("[ERROR] " + e)
...
try{
      ...
      */
      ...
      df5.repartition(numPartitions).write.format("delta").mode(SaveMode.Overwrite).save(path_data)
