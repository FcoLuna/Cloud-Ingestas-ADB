...
var dir_adls = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/trafico/trafico_mediado_movil/mediacion"
...
val PathStage = dir_adls + "/xdr/stage"
val PathLanding = dir_adls + "/xdr/landing"
...
val keywords = List("ind","mmt","pta","ccp","chi","chl")
...
val result =1334// BigDecimal(iqFilesCount / 15.0).setScale(0, RoundingMode.UP).toInt
