...
dbutils.widgets.text("ruta_origen","/data/trafico/trafico_detalle/smartcare/landing/cdr_aiu_moc/")
dbutils.widgets.text("path_salida","/data/trafico/trafico_detalle/smartcare/cdr_aiu_moc/")
...
val landing_aiumoc = path_adls + dbutils.widgets.get("ruta_origen")
...
val aiumoc = spark.read.option("delimiter","|").schema(schema).csv(landing_aiumoc)
