...
dbutils.widgets.text("ruta_origen","/data/trafico/trafico_detalle/smartcare/landing/fileaccess/")
dbutils.widgets.text("path_salida","/data/trafico/trafico_detalle/smartcare/fileaccess/raw/")
dbutils.widgets.text("catalogo","bi_ingestas")
dbutils.widgets.text("tabla_salida","trafico_cert.smartcare_fileaccess") 
*/
