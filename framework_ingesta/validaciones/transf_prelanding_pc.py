...
# # # Variables Pruebas
ruta_stage      = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/gestion_recursos/operacion_red/ookla/speedtest_data_suplem_sensible/stage"
ruta_destino    = "abfss://ingestas@stbigdatadev02.dfs.core.windows.net/data/gestion_recursos/operacion_red/ookla/speedtest_data_suplem_sensible/landing"
nombre_archivo  = "SensitiveData_2024-11-14.csv"
validate        = False
...
#   # Parámetros ingesta compuesta
   filenamespark            = "SensitiveData_20241114.csv"
   nombre_proceso          = "SPEEDTEST_DATA_SUPLEM_SENSIBLE" 
   partition_landing       = "m"
   file_date               = "2024-11-14"
   format_date_filename_in = "yyyy-MM-dd"
...
print("nombre_archivo_landing: ", nombre_archivo_landing + "| file_size: " + file_size)
