...
#
#dbutils.widgets.text("ruta_stage","abfss://bigdataprd@stbigdataprd02.dfs.core.windows.net/data/gestion_recursos/logistica/sap/movimientos1/stage")
#dbutils.widgets.text("ruta_destino", "abfss://bigdataprd@stbigdataprd02.dfs.core.windows.net/data/gestion_recursos/logistica/sap/movimientos1/landing")
#dbutils.widgets.text("nombre_archivo", "1594_Movimientos_1_20250107.txt")
#dbutils.widgets.text("validate","false")
#dbutils.widgets.text("validate_schema", "[ ['StringType',(0,500)], ['StringType',(0,500)],  ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)],  ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)],  ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)],  ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)], ['StringType',(0,500)],  ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)],   ['StringType',(0,500)]]")
#dbutils.widgets.text("replace_text", "true")
#dbutils.widgets.text("replace_schema", "[ ('(\\\\,)',','), ('&(#129|#137|#141|#145|#147|#154|gt);',' ') ]")
...
#dbutils.widgets.text("file_size", "1295301")
#dbutils.widgets.text("is_compuesta", "true")

#dbutils.widgets.text("filenamespark", "1594_Movimientos_1_20250107.txt") # se agrega el 17-oct-24
#dbutils.widgets.text("nombre_proceso", "MOVIMIENTOS_1")
#dbutils.widgets.text("partition_landing", "m")
#dbutils.widgets.text("file_date", "20250107")
#dbutils.widgets.text("format_date_filename_in", "yyyyMMdd")
#dbutils.widgets.text("format_ts", "yyyyMMddHHmmss")
#
...
if is_compuesta:
    ...
    if fileExists(ruta_destino, nombre_archivo_landing):
        ...
        df_count = df.count()
        df_count_2 = dforiginal.count()
        if df_count == 0:  
            if df_count_2 == 0:
                print("No hay datos en el archivo de particion")
        else:
            if df_count_2 == 0:
