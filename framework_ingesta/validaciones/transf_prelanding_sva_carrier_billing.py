...
df = df.select(
    ...
    col("Estatus"), 
    col("`Estatus Usu.`"), 
    try_to_timestamp(col("Fecha Alta"), lit('MM/dd/yyyy hh:mm:ss a')).alias("Fecha_Alta"), 
    col("Canal Alta"), 
    col("Origen Alta"), 
    try_to_timestamp(col("Fecha Baja"), lit('MM/dd/yyyy hh:mm:ss a')).alias("Fecha_Baja"), 
    col("Canal Baja"), 
    col("Origen Baja"), 
    col("KW Alta"), 
    col("KW Baja"), 
    try_to_timestamp(col("Ultimo Cobro OK"), lit('MM/dd/yyyy hh:mm:ss a')).alias("Ultimo_Cobro_OK"), 
    col("Codigo de Tasacion"))
display(df)
