...
dbutils.widgets.text("ruta_origen","/data/trafico/trafico_detalle/smartcare/tdr_ims_inf_register_sip_test/landing")
dbutils.widgets.text("path_salida","/data/trafico/trafico_detalle/smartcare/tdr_ims_inf_register_sip/raw")
dbutils.widgets.text("catalogo","bidesarrollo")
dbutils.widgets.text("tabla_salida","raw_trafico.smartcare_tdr_ims_inf_register_sip")*/
...
val query = df.writeStream
  ...
  .option("checkpointLocation", s"${path_adls_smartcare}/checkpoints/tdr_ims_inf_register_sip") // Ruta de checkpoints
...
while (query.isActive) {
  ...
  if (lastProgress != null) {
    ...
    println(s"📌 Último Checkpoint: ${s"${path_adls_smartcare}/checkpoints/tdr_ims_inf_register_sip"}")
