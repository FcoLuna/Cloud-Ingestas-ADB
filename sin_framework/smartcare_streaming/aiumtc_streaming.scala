...
dbutils.widgets.text("ruta_origen","/data/trafico/trafico_detalle/smartcare/cdr_aiu_mtc_test/landing")
dbutils.widgets.text("path_salida","/data/trafico/trafico_detalle/smartcare/cdr_aiu_mtc_test/raw")
...
val query = df.writeStream
  ...
  .option("checkpointLocation", s"${path_adls_smartcare}/checkpoints/aiumtc") // Ruta de checkpoints
...
while (query.isActive) {
  ...
  if (lastProgress != null) {
    ...
    println(s"📌 Último Checkpoint: ${s"${path_adls_smartcare}/checkpoints/aiumtc"}")
