...
dbutils.widgets.text("ruta_origen","/data/trafico/trafico_detalle/smartcare/tdr_ims_inf_miscellaneous_sip_test/landing")
dbutils.widgets.text("path_salida","/data/trafico/trafico_detalle/smartcare/tdr_ims_inf_miscellaneous_sip/raw")
dbutils.widgets.text("catalogo","bidesarrollo")
dbutils.widgets.text("tabla_salida","raw_trafico.smartcare_tdr_ims_inf_miscellaneous_sip")*/
...
val df_origen = spark.readStream
  ...
  .option("cloudFiles.schemaLocation", s"${path_adls_smartcare}/schemas/tdr_ims_inf_miscellaneous_sip") // Ruta para el esquema
...
val query = df.writeStream
  ...
  .option("checkpointLocation", s"${path_adls_smartcare}/checkpoints/tdr_ims_inf_miscellaneous_sip") // Ruta de checkpoints
...
while (query.isActive) {
  ...
  if (lastProgress != null) {
    ...
    println(s"📌 Último Checkpoint: ${s"${path_adls_smartcare}/checkpoints/tdr_ims_inf_miscellaneous_sip"}")
